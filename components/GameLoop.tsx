import { ArrowRight, Check, Gavel, Hand, HelpCircle } from 'lucide-react';
import React, { useEffect, useRef, useState } from 'react';
import { MAX_TURNS } from '../constants';
import { cn, getRandomInt, getRandomItem, mulberry32 } from '../lib/utils';
import { AttachedItem, GameState, Pack, PackItem, Tier } from '../types';
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-12 w-full">
          ...
          >
            <div className="relative group">
              ...
              <div className="absolute -top-2 -right-2 bg-accent text-white px-3 py-1 rounded-full text-xs font-bold border-2 border-white shadow-sm transform z-[1000000] rotate-12 flex items-center gap-1 animate-bounce-slow">
          ...
          <div className="relative w-full flex justify-center">
            ...
            <div
              ...
              className={cn(
                ...
                dragState.isDragging
                  ? 'z-[9999] shadow-[16px_16px_0px_0px_rgba(28,25,23,0.5)] scale-105'
